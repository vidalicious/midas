...
def main():
    ...
    for key in [COL_CURRENT_PRICE, 'circ_mv']:
    ...
    data_frame = data_frame[
                           (data_frame[COL_CURRENT_PRICE] < 10)
    ...
    sorted_frame = data_frame.sort_values(by=COL_CURRENT_PRICE, ascending=True)

    file_name = '../logs/{date}@RoughSearch.csv'.format(date=LAST_MARKET_DATE)
    # print(fileName)
