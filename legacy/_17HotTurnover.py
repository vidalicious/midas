...
def _main():
    ...
    for i, code in enumerate(basics.index):
        ...
        try:
            ...
            frame.loc[code, COL_TURNOVER] = api.hist_average_turnover(hist_data, begin=DAY_RANGE[0], end=DAY_RANGE[1])
    ...
    sorted_frame = filtered_frame.sort_values(by=COL_TURNOVER, ascending=False)
    print(sorted_frame)
