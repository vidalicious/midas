...
def _main():
    ...
    for i, code in enumerate(basics.index):
        ...
        try:
            ...
            frame.loc[code, COL_SORT_KEY] = - frame.loc[code, COL_P_CHANGE_12]
    ...
    filtered_frame = frame[(frame[COL_P_CHANGE_01] < -6)
    ...
    file_name = '../logs/{date}@DragonWorrior.csv'.format(date=LAST_MARKET_DATE)
    # print(fileName)
