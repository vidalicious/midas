...
def aggressive_count(sequence, window_width, rate):
...
def plot_candle_gather(data_frame, last_date, sub, offset):
    ...
    plt.tight_layout()
    plt.savefig('../../buffer/window_aggressive/{date}_window_aggressive_{sub}.png'.format(date=last_date, sub=sub))
