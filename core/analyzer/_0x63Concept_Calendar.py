    ...
    raw_data = [
        {
            ...
            'date': 20210507,
            'concepts': ['钢铁', '煤炭', '有色', '医美', '区块链', '黄金', '二胎', '化工', '百年庆典']
        }, {
            'date': 20210510,
            'concepts': ['钢铁', '有色', '二胎', '医美', '煤炭', '养老', '区块链', '锂电池', '预制菜', '疫苗', '石油石化', '化工', '百年庆典', '新能源汽车', '金刚石']
        }, {
            'date': 20210511,
            ...
            'date': 20210513,
            'concepts': ['医药', '房地产', '医美', '二胎', '华为', '食品饮料', '养老']
        }, {
            'date': 20210514,
            ...
            'date': 20210531,
            'concepts': ['碳中和', '锂电池', '汽车配件', '芯片', '医药', '二胎', '医美', '网红', '光伏', '机器人', '自行车', '食品饮料', '云计算', '基础建设']
        }
    ]
