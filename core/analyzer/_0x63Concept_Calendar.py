...
def main():
    raw_data = [
        {
            'date': 20210427,
            'concepts': ['多胎', '服装家纺', '医美', '医药', '食品饮料', '区块链']
        }, {
            'date': 20210428,
            'concepts': ['医美', '医药', '多胎', '酿酒', '煤炭', '服装家纺', '旅游']
        }, {
            'date': 20210429,
            'concepts': ['医美', '服装家纺', '芯片', '酿酒', '多胎', '化工']
        }, {
            'date': 20210430,
            ...
            'date': 20210602,
            'concepts': ['碳中和', '服装家纺', '医药', '石油石化', '煤炭', '海航系', '汽车配件']
        }, {
            'date': 20210603,
            'concepts': ['上海', '5G', '碳中和', '锂电池', '芯片', '酿酒', '煤炭', '有色', '服装家纺',
                         '碳中和', '养老', '参股金融']
        }, {
            'date': 20210604,
            'concepts': ['锂电池', '酿酒', '新能源汽车', '芯片', '5G', '医药', '服装家纺']
        }, {
            'date': 20210607,
            'concepts': ['华为', '酿酒', '芯片', '锂电池', '化工', '医药']
        }
    ]
