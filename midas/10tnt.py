...
COL_NEXTDAYUPLIMIT = 'next_day_up_limit'
K_UP_LIMIT_RATIO = 3
...
def _main():
    ...
    for i, code in enumerate(basics.index):
        ...
        try:
            ...
            frame.loc[code, COL_NEXTDAYUPLIMIT] = round(api.last_ma5(hist_data) + K_UP_LIMIT_RATIO * api.std_close(hist_data, begin=0, end=5), 3)
