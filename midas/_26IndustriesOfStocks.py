...
def main():
    ...
    # data_frame = data_frame.groupby('industry')

    sorted_frame = data_frame.sort_values(by='industry', ascending=False)

    file_name = '../logs/{date}@IndustriesOfStocks.csv'.format(date=LAST_MARKET_DATE)
    # print(fileName)
